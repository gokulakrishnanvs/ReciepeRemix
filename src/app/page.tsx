    ...
    <div className="container mx-auto py-8 px-4 flex flex-col items-center space-y-12">
      ...
      {isLoading && (
        <div className="flex flex-col items-center space-y-2">
          ...
          <p className="text-lg text-muted-foreground">Whipping up something special...</p>
        </div>
      )}
      ...
      {!generatedRecipe && !isLoading && (
         <Alert className="max-w-lg mx-auto shadow-md border-accent">
          <Terminal className="h-4 w-4 text-accent" />
          <AlertTitle className="text-accent">Ready to Cook?</AlertTitle>
          <AlertDescription>
            Add some ingredients and click "Generate Recipe" to get started!
          </AlertDescription>
        </Alert>
      )}
