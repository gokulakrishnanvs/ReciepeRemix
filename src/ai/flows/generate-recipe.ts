...
const GenerateRecipeOutputSchema = z.object({
  ...
  estimatedPrepTime: z.string().describe('Estimated preparation time for the recipe'),
  estimatedCookTime: z.string().describe('Estimated cooking time for the recipe'),
  servingSize: z.string().describe('Number of servings the recipe yields'),
});
...
const generateRecipePrompt = ai.definePrompt({
  ...
  prompt: `Given the following ingredients, generate a detailed recipe.

Ingredients: {{{ingredients}}}

Instructions:`, // Could be improved to be more structured
});
